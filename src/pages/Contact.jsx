...
const Contact = () => {
 ...
 const handleForm=(data)=>{
  ...
  return (
    <div className="flex flex-col items-center gap-5 md:gap-10 md:items-center px-2">
      <h1 className="text-3xl md:text-5xl font-bold text-center">Contact Us</h1>
      <form action={handleForm} className="flex flex-col gap-1 md:gap-2 w-72 md:w-[60%] max-w-[576px] p-4 md:p-10 bg-radial-[at_25%_25%] from-zinc-700 to-zinc-900 to-75% border-1 border-white rounded-2xl ">
